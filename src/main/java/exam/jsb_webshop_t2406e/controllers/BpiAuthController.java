...
// @CrossOrigin(origins = "*", maxAge = 3600) // for RestMAN only, gây chết
/**
 * Thiết kế riêng cho Backend API, không phải cho reactjs, angularjs, vuejs
 */
// @CrossOrigin(origins = "*", maxAge = 3600)
@RestController
@RequestMapping("/bpi/auth") // test thử cơ chế bắt lỗi: http://localhost:6868/api/xxxyyy
public class BpiAuthController 
{
  @Autowired
